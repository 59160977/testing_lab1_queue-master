...
test('สร้าง queue ใหม่แล้วทดสอบว่า empty มีค่าเป้น true (ว่าง)', ()=> {
   const queue = new Queue(1);
   expect(queue.empty()).toBe(true);
});
// 2. สร้าง queue size 1 และ ทดสอบว่าสามารถ enqueue(20) และ dequeues ค่าที่ได้จะได้ 20
